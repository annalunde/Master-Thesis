...
def main(test_instance, test_instance_date, iterations):
    ...
    try:
        ...
        current_route_plan, current_objective, current_infeasible_set, _ = alns.iterate(
            iterations, initial_Z, None, None, None, delayed, False)
...
if __name__ == "__main__":
    ...
    for test_instance in test_instances:
        ...
        for run in range(runs):
            ...
            total_objective, rejected, rejected_objective, deviation_objective, ride_time_objective = main(test_instance, "2021-05-10 10:00:00",
                                                                                                           iterations)
        ...
        df_tracking.to_csv(config("tuning_path") + "param_tuning" +
                           str(destruction_degree) + "_" + test_instance + ".csv")  # Path:  param_tuning_reactionfac_instance
